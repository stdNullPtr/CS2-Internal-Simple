...
namespace ImStb
{
    ...
    static char STB_TEXTEDIT_GETCHAR(const ImGuiInputTextState* obj, int idx)
    {
        ...
        return obj->TextA[idx];
    }

    static float STB_TEXTEDIT_GETWIDTH(ImGuiInputTextState* obj, int line_start_idx, int char_idx)
    {
        unsigned int c;
        ImTextCharFromUtf8(&c, obj->TextA.Data + line_start_idx + char_idx, obj->TextA.Data + obj->TextLen);
...
#define IMSTB_TEXTEDIT_GETPREVCHARINDEX  IMSTB_TEXTEDIT_GETPREVCHARINDEX_IMPL
    ...
    static int is_word_boundary_from_right(ImGuiInputTextState* obj, int idx)
    {
        ...
        unsigned int curr_c;
        ImTextCharFromUtf8(&curr_c, curr_p, obj->TextA.Data + obj->TextLen);
        unsigned int prev_c;
        ImTextCharFromUtf8(&prev_c, prev_p, obj->TextA.Data + obj->TextLen);
    ...
    static int is_word_boundary_from_left(ImGuiInputTextState* obj, int idx)
    {
        ...
        const char* prev_p = ImTextFindPreviousUtf8Codepoint(obj->TextA.Data, curr_p);
        unsigned int prev_c;
        ImTextCharFromUtf8(&prev_c, curr_p, obj->TextA.Data + obj->TextLen);
        unsigned int curr_c;
        ImTextCharFromUtf8(&curr_c, prev_p, obj->TextA.Data + obj->TextLen);
